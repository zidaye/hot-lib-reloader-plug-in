...
pub(crate) fn generate_lib_loader_items(
    ...
    let result = quote::quote_spanned! {span=>
        ...
        fn __lib_notifier() -> ::std::sync::Arc<::std::sync::RwLock<::hot_lib_reloader_plug_in::LibReloadNotifier>> {
        ...
        fn __lib_loader_subscription() -> ::hot_lib_reloader_plug_in::LibReloadObserver {
...
/// pub fn rx() -> std::sync::mpsc::Receiver<hot_lib_reloader_plug_in::ChangedEvent> {
